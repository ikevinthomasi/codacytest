...
public partial class ED_Admin_Action_COI_Details : System.Web.UI.Page
{
    DataRow row = null;
    DataView dv = null;
    String qs = "";
    ...
    protected void btnReview_Click(object sender, EventArgs e)
    {
        ...
        qs = qs + " SET ";
        qs = qs + " rmd_rev_resolution = @prmd_rev_resolution, ";
        qs = qs + " rmcd_rev_url = @prmcd_rev_url, ";
        qs = qs + " rmd_flag = @prmd_flag, ";
        ...
        cmd.Parameters.AddWithValue("@pdeclare_no", Request.QueryString["rid"].ToString());
        cmd.Parameters.AddWithValue("@pstaff_ic", Request.QueryString["rpid"].ToString());
        cmd.Parameters.AddWithValue("@prmd_rev_resolution", fldRemarks.Text);
        cmd.Parameters.AddWithValue("@prmcd_rev_url", urlStr);
        cmd.Parameters.AddWithValue("@prmd_flag", "Yes");
        ...
        //redirect to page
        Response.Redirect("ED_Admin_Action_COI.aspx");
    }
    ...
    private void emailnotification(String reqNo, String coiDesc)
    {
        ...
        bodyMail = bodyMail + "</tr>";
        bodyMail = bodyMail + "<tr>";
        bodyMail = bodyMail + "<td colspan='3'>The following conflict of interest declaration is pending for your final action to be closed in the portal :<br/><br/></td>";
        bodyMail = bodyMail + "</tr>";
        bodyMail = bodyMail + "<tr>";
        ...
        mailMsg.Subject = "Completed Verification / Closure of COI [ACTION REQUIRED] : " + reqNo;
    ...
    private String uploadAttachment(String reqId, String ICNo)
    {
        ...
        String filenameStr = "RMCD_Review_" + reqId;
