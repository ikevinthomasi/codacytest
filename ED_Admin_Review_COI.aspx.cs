...
public partial class ED_Admin_Review_COI : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            dvTemp.RowFilter = "status = 'Review'";
    ...
    protected void lblDeclareNo_DataBinding(object sender, EventArgs e)
    {
        ...
        lt.Text = "<a href='ED_Admin_Review_COI_Details.aspx?rid=" + Eval("declare_no") + "&rpid=" + Eval("staff_ic") + "'>" + Eval("declare_no") + "</a>";
    }
}