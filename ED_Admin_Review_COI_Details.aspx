<%@ Page Title="" Language="C#" MasterPageFile="~/AED_Main_MasterPage.master" AutoEventWireup="true" CodeFile="ED_Admin_Review_COI_Details.aspx.cs" Inherits="ED_Admin_Review_COI_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-6">
            <label class="small">RMCD Resolution / Remarks &nbsp; <i class="fa fa-asterisk text-danger"></i></label>
            <asp:TextBox ID="fldRemarks" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="5"></asp:TextBox>
            <div class="invalid-feedback">Valid Resolution / Remarks is required.</div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-2 offset-md-5">
            <asp:Button ID="btnRecommend" runat="server" Text="Recommend" CssClass="btn btn-sm btn-primary btn-block" OnClick="btnRecommend_Click" OnClientClick="return validateErr();" />
        </div>
    </div>      
