<%@ Page Title="" Language="C#" MasterPageFile="~/AED_Main_MasterPage.master" AutoEventWireup="true" CodeFile="ED_User_Review_COI_Details.aspx.cs" Inherits="ED_User_Review_COI_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-6">
            <label class="small">Resolution &nbsp; <i class="fa fa-asterisk text-danger"></i></label>
            <asp:TextBox ID="fldResolution" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="5"></asp:TextBox>
...
<script type="text/javascript">
    function validateErr()
    {
        ...
        document.getElementById('<%=fldResolution.ClientID%>').className = "form-control form-control-sm";

        if (document.getElementById('<%=fldResolution.ClientID%>').value == "")
        {
                document.getElementById('<%=fldResolution.ClientID%>').className = "form-control form-control-sm is-invalid";
                chckErr = false;
        }
        ...
        if (document.getElementById('<%=fldAttachment.ClientID%>').value != "") {
            ...
            var allowedExtensions = ['pdf', 'PDF', 'doc', 'DOC', 'docx', 'DOCX', 'xls', 'XLS', 'xlsx', 'XLSX', 'jpg', 'JPG', 'jpeg', 'JPEG', 'png', 'PNG', 'ppt', 'PPT', 'pptx', 'PPTX', 'txt', 'TXT'];
