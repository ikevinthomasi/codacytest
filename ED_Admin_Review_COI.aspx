<%@ Page Title="" Language="C#" MasterPageFile="~/AED_Main_MasterPage.master" AutoEventWireup="true" CodeFile="ED_Admin_Review_COI.aspx.cs" Inherits="ED_Admin_Review_COI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        <div class="col-md-12">
            <label class="form-control-lg"><b>Pending Verification</b></label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <label class="form-control-sm"><b>Total Pending Review Form</b></label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Review Date" ItemStyle-Width="10%" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:Label ID="lblDeclareDate" runat="server" Text='<%#Convert.ToDateTime(Eval("review_date")).ToString("dd-MMM-yyyy HH:mm:ss") %>'></asp:Label><br />
                </ItemTemplate>
                </asp:TemplateField>
            </Columns>
