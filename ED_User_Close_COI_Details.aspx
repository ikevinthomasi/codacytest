<%@ Page Title="" Language="C#" MasterPageFile="~/AED_Main_MasterPage.master" AutoEventWireup="true" CodeFile="ED_User_Close_COI_Details.aspx.cs" Inherits="ED_User_Close_COI_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--hod review info details--%>
    <div id="dvHODReview" runat="server">
        <div class="row">
            <div class="col-md-6">
                <label class="small">HOD Resolution</label>
                <asp:TextBox ID="fldHODResolution" runat="server" Enabled="false" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="10"></asp:TextBox>
            </div>
            <div class="col-md-6">
                <label class="small">Attachment</label>
                <div class="input-group">
                    <asp:Label ID="lblHODRAttachment" runat="server" CssClass="form-control form-control-sm" />
                    <div class="input-group-append">
                        <asp:LinkButton ID="btnHODRAttachment" runat="server" CssClass="btn btn-secondary btn-sm">View Attachment</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <label class="small">RMCD Resolution / Remarks</label>
            <asp:TextBox ID="fldRMCDRemarks" runat="server" Enabled="false" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="10"></asp:TextBox>
        </div>
        <div class="col-md-6">
            <label class="small">Attachment</label>
            <div class="input-group">
                <asp:Label ID="lblRMCDRAttachment" runat="server" CssClass="form-control form-control-sm" />
                <div class="input-group-append">
                    <asp:LinkButton ID="btnRMCDRAttachment" runat="server" CssClass="btn btn-secondary btn-sm">View Attachment</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <label class="small">HOD Completion Justification &nbsp; <i class="fa fa-asterisk text-danger"></i></label>
            <asp:TextBox ID="fldHODRemarks" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="5"></asp:TextBox>
            <div class="invalid-feedback">Valid Completion Justification is required.</div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-2 offset-md-5">
            <asp:Button ID="btnClose" runat="server" Text="Complete" CssClass="btn btn-sm btn-primary btn-block" OnClick="btnClose_Click" OnClientClick="return validateErr();" />
        </div>
    </div>      
...
<script type="text/javascript">
    ...
    function validateErr() {
        ...
        document.getElementById('<%=fldHODRemarks.ClientID%>').className = "form-control form-control-sm";

        if (document.getElementById('<%=fldHODRemarks.ClientID%>').value == "")
        {
                document.getElementById('<%=fldHODRemarks.ClientID%>').className = "form-control form-control-sm is-invalid";
                chckErr = false;
        }
