<%@ Page Title="" Language="C#" MasterPageFile="~/AED_Main_MasterPage.master" AutoEventWireup="true" CodeFile="ED_User_View_Staff_COI_Details.aspx.cs" Inherits="ED_User_View_Staff_COI_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--hod review info details--%>
    <div id="dvRMCDReview" runat="server">
        <div class="row">
            <div class="col-md-6">
    ...
    <%--hod close info details--%>
    <div id="dvHODClose" runat="server">
        <div class="row">
            <div class="col-md-6">
                <label class="small">HOD Completion Justification</label>
                <asp:TextBox ID="fldHODJustification" runat="server" Enabled="false" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="10"></asp:TextBox>
            </div>
            <div class="col-md-6">
                <label class="small">Attachment</label>
                <div class="input-group">
                    <asp:Label ID="lblHODCAttachment" runat="server" CssClass="form-control form-control-sm" />
                    <div class="input-group-append">
                        <asp:LinkButton ID="btnHODCAttachment" runat="server" CssClass="btn btn-secondary btn-sm">View Attachment</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
